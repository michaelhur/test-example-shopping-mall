...
// 하지만 renderHook을 이용하여 테스트시 바로 사용 가능
it('호출 시 initialValue 인자를 지정하지 않는 경우 isModalOpened 상태가 false로 설정된다.', () => {
  // result: 훅을 호출하여 얻은 결과 값은 반환
  // -> result.current 값을 참조하여 최신 상태를 추적할 수 있다.
...
it('훅의 toggleIsModalOpened()를 호출하면 isModalOpened 상태가 toggle된다.', () => {
  ...
  // userEvent 또는 render를 사용하지않고 직접 상태를 변경하는 경우에는 act로 감싸주어야 함.
